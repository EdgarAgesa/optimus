...
const menuData = [
  {
    ...
    sub: [
      ...
      { label: 'Accessories', slug: 'gaming', brands: ['PS4', 'PS5', 'Nintendo', 'Xbox', 'VR', 'Driving Wheel', 'Handheld'] },
    ],
  },
  {
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .mobile-menu-header {
          ...
          align-items: center;
          padding: 16px 20px;
          back<a<a<aground: linear-gradient(135deg, #0d2b33, #0097a7);
          flex-shrink: 0;
        }
        .mobile-menu-logo {
          height: 36px;
      ...
      <header className="nav-header">
        ...
        <div className="main-bar">
          <div className="main-inner">
            ...
            {/* Desktop search — no category dropdown */}
        ...
        {/* Mobile search — no category dropdown */}
